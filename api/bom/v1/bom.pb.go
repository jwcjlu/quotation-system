...
const file_bom_v1_bom_proto_rawDesc = "" +
	...
	"\x02ok\x18\x01 \x01(\tR\x02ok2\x8f \n" +
	"\n" +
	"BomService\x12d\n" +
...
var file_bom_v1_bom_proto_msgTypes = make([]protoimpl.MessageInfo, 95)
var file_bom_v1_bom_proto_goTypes = []any{
	...
	(*BOMLineGap)(nil),                          // 58: api.bom.v1.BOMLineGap
	(*ListLineGapsRequest)(nil),                 // 59: api.bom.v1.ListLineGapsRequest
	(*ListLineGapsReply)(nil),                   // 60: api.bom.v1.ListLineGapsReply
	(*ResolveLineGapManualQuoteRequest)(nil),    // 61: api.bom.v1.ResolveLineGapManualQuoteRequest
	(*ResolveLineGapManualQuoteReply)(nil),      // 62: api.bom.v1.ResolveLineGapManualQuoteReply
	(*SelectLineGapSubstituteRequest)(nil),      // 63: api.bom.v1.SelectLineGapSubstituteRequest
	(*SelectLineGapSubstituteReply)(nil),        // 64: api.bom.v1.SelectLineGapSubstituteReply
	(*SaveMatchRunRequest)(nil),                 // 65: api.bom.v1.SaveMatchRunRequest
	(*SaveMatchRunReply)(nil),                   // 66: api.bom.v1.SaveMatchRunReply
	(*MatchRunListItem)(nil),                    // 67: api.bom.v1.MatchRunListItem
	(*ListMatchRunsRequest)(nil),                // 68: api.bom.v1.ListMatchRunsRequest
	(*ListMatchRunsReply)(nil),                  // 69: api.bom.v1.ListMatchRunsReply
	(*MatchRunResultItem)(nil),                  // 70: api.bom.v1.MatchRunResultItem
	(*GetMatchRunRequest)(nil),                  // 71: api.bom.v1.GetMatchRunRequest
	(*GetMatchRunReply)(nil),                    // 72: api.bom.v1.GetMatchRunReply
	(*ExportSessionRequest)(nil),                // 73: api.bom.v1.ExportSessionRequest
	(*ExportSessionReply)(nil),                  // 74: api.bom.v1.ExportSessionReply
	(*HsResolveByModelRequest)(nil),             // 75: api.bom.v1.HsResolveByModelRequest
	(*UploadHsManualDatasheetRequest)(nil),      // 76: api.bom.v1.UploadHsManualDatasheetRequest
	(*UploadHsManualDatasheetReply)(nil),        // 77: api.bom.v1.UploadHsManualDatasheetReply
	(*HsResolveCandidate)(nil),                  // 78: api.bom.v1.HsResolveCandidate
	(*HsResolveByModelReply)(nil),               // 79: api.bom.v1.HsResolveByModelReply
	(*HsResolveTaskRequest)(nil),                // 80: api.bom.v1.HsResolveTaskRequest
	(*HsResolveTaskReply)(nil),                  // 81: api.bom.v1.HsResolveTaskReply
	(*HsResolveConfirmRequest)(nil),             // 82: api.bom.v1.HsResolveConfirmRequest
	(*HsResolveConfirmReply)(nil),               // 83: api.bom.v1.HsResolveConfirmReply
	(*HsResolveHistoryRequest)(nil),             // 84: api.bom.v1.HsResolveHistoryRequest
	(*HsResolveHistoryItem)(nil),                // 85: api.bom.v1.HsResolveHistoryItem
	(*HsResolveHistoryReply)(nil),               // 86: api.bom.v1.HsResolveHistoryReply
	(*HsMetaListRequest)(nil),                   // 87: api.bom.v1.HsMetaListRequest
	(*HsMetaListRow)(nil),                       // 88: api.bom.v1.HsMetaListRow
	(*HsMetaListReply)(nil),                     // 89: api.bom.v1.HsMetaListReply
	(*HsMetaCreateRequest)(nil),                 // 90: api.bom.v1.HsMetaCreateRequest
	(*HsMetaUpdateRequest)(nil),                 // 91: api.bom.v1.HsMetaUpdateRequest
	(*HsMetaDeleteRequest)(nil),                 // 92: api.bom.v1.HsMetaDeleteRequest
	(*HsMetaMutationReply)(nil),                 // 93: api.bom.v1.HsMetaMutationReply
	nil,                                         // 94: api.bom.v1.UploadBOMRequest.ColumnMappingEntry
}
var file_bom_v1_bom_proto_depIdxs = []int32{
	94, // 0: api.bom.v1.UploadBOMRequest.column_mapping:type_name -> api.bom.v1.UploadBOMRequest.ColumnMappingEntry
	...
	58, // 17: api.bom.v1.ListLineGapsReply.gaps:type_name -> api.bom.v1.BOMLineGap
	67, // 18: api.bom.v1.ListMatchRunsReply.runs:type_name -> api.bom.v1.MatchRunListItem
	67, // 19: api.bom.v1.GetMatchRunReply.run:type_name -> api.bom.v1.MatchRunListItem
	70, // 20: api.bom.v1.GetMatchRunReply.items:type_name -> api.bom.v1.MatchRunResultItem
	78, // 21: api.bom.v1.HsResolveByModelReply.candidates:type_name -> api.bom.v1.HsResolveCandidate
	78, // 22: api.bom.v1.HsResolveTaskReply.candidates:type_name -> api.bom.v1.HsResolveCandidate
	78, // 23: api.bom.v1.HsResolveHistoryItem.candidates:type_name -> api.bom.v1.HsResolveCandidate
	85, // 24: api.bom.v1.HsResolveHistoryReply.items:type_name -> api.bom.v1.HsResolveHistoryItem
	88, // 25: api.bom.v1.HsMetaListReply.items:type_name -> api.bom.v1.HsMetaListRow
	0,  // 26: api.bom.v1.BomService.UploadBOM:input_type -> api.bom.v1.UploadBOMRequest
	3,  // 27: api.bom.v1.BomService.SearchQuotes:input_type -> api.bom.v1.SearchQuotesRequest
	7,  // 28: api.bom.v1.BomService.AutoMatch:input_type -> api.bom.v1.AutoMatchRequest
	26, // 29: api.bom.v1.BomService.DownloadTemplate:input_type -> api.bom.v1.DownloadTemplateRequest
	10, // 30: api.bom.v1.BomService.GetBOM:input_type -> api.bom.v1.GetBOMRequest
	12, // 31: api.bom.v1.BomService.GetMatchResult:input_type -> api.bom.v1.GetMatchResultRequest
	14, // 32: api.bom.v1.BomService.ListMatchSources:input_type -> api.bom.v1.ListMatchSourcesRequest
	19, // 33: api.bom.v1.BomService.GetMatchSourceDetail:input_type -> api.bom.v1.GetMatchSourceDetailRequest
	21, // 34: api.bom.v1.BomService.ListManufacturerCanonicals:input_type -> api.bom.v1.ListManufacturerCanonicalsRequest
	24, // 35: api.bom.v1.BomService.CreateManufacturerAlias:input_type -> api.bom.v1.CreateManufacturerAliasRequest
	28, // 36: api.bom.v1.BomService.CreateSession:input_type -> api.bom.v1.CreateSessionRequest
	30, // 37: api.bom.v1.BomService.GetSession:input_type -> api.bom.v1.GetSessionRequest
	32, // 38: api.bom.v1.BomService.ListSessions:input_type -> api.bom.v1.ListSessionsRequest
	35, // 39: api.bom.v1.BomService.PatchSession:input_type -> api.bom.v1.PatchSessionRequest
	36, // 40: api.bom.v1.BomService.PutPlatforms:input_type -> api.bom.v1.PutPlatformsRequest
	38, // 41: api.bom.v1.BomService.GetReadiness:input_type -> api.bom.v1.GetReadinessRequest
	40, // 42: api.bom.v1.BomService.GetBOMLines:input_type -> api.bom.v1.GetBOMLinesRequest
	43, // 43: api.bom.v1.BomService.GetSessionSearchTaskCoverage:input_type -> api.bom.v1.GetSessionSearchTaskCoverageRequest
	47, // 44: api.bom.v1.BomService.CreateSessionLine:input_type -> api.bom.v1.CreateSessionLineRequest
	49, // 45: api.bom.v1.BomService.PatchSessionLine:input_type -> api.bom.v1.PatchSessionLineRequest
	51, // 46: api.bom.v1.BomService.DeleteSessionLine:input_type -> api.bom.v1.DeleteSessionLineRequest
	53, // 47: api.bom.v1.BomService.RetrySearchTasks:input_type -> api.bom.v1.RetrySearchTasksRequest
	56, // 48: api.bom.v1.BomService.SubmitBomSearchResult:input_type -> api.bom.v1.SubmitBomSearchResultRequest
	59, // 49: api.bom.v1.BomService.ListLineGaps:input_type -> api.bom.v1.ListLineGapsRequest
	61, // 50: api.bom.v1.BomService.ResolveLineGapManualQuote:input_type -> api.bom.v1.ResolveLineGapManualQuoteRequest
	63, // 51: api.bom.v1.BomService.SelectLineGapSubstitute:input_type -> api.bom.v1.SelectLineGapSubstituteRequest
	65, // 52: api.bom.v1.BomService.SaveMatchRun:input_type -> api.bom.v1.SaveMatchRunRequest
	68, // 53: api.bom.v1.BomService.ListMatchRuns:input_type -> api.bom.v1.ListMatchRunsRequest
	71, // 54: api.bom.v1.BomService.GetMatchRun:input_type -> api.bom.v1.GetMatchRunRequest
	73, // 55: api.bom.v1.BomService.ExportSession:input_type -> api.bom.v1.ExportSessionRequest
	75, // 56: api.bom.v1.HsResolveService.ResolveByModel:input_type -> api.bom.v1.HsResolveByModelRequest
	80, // 57: api.bom.v1.HsResolveService.GetResolveTask:input_type -> api.bom.v1.HsResolveTaskRequest
	82, // 58: api.bom.v1.HsResolveService.ConfirmResolve:input_type -> api.bom.v1.HsResolveConfirmRequest
	84, // 59: api.bom.v1.HsResolveService.GetResolveHistory:input_type -> api.bom.v1.HsResolveHistoryRequest
	76, // 60: api.bom.v1.HsResolveService.UploadHsManualDatasheet:input_type -> api.bom.v1.UploadHsManualDatasheetRequest
	87, // 61: api.bom.v1.HsMetaService.ListHsMeta:input_type -> api.bom.v1.HsMetaListRequest
	90, // 62: api.bom.v1.HsMetaService.CreateHsMeta:input_type -> api.bom.v1.HsMetaCreateRequest
	91, // 63: api.bom.v1.HsMetaService.UpdateHsMeta:input_type -> api.bom.v1.HsMetaUpdateRequest
	92, // 64: api.bom.v1.HsMetaService.DeleteHsMeta:input_type -> api.bom.v1.HsMetaDeleteRequest
	1,  // 65: api.bom.v1.BomService.UploadBOM:output_type -> api.bom.v1.UploadBOMReply
	4,  // 66: api.bom.v1.BomService.SearchQuotes:output_type -> api.bom.v1.SearchQuotesReply
	8,  // 67: api.bom.v1.BomService.AutoMatch:output_type -> api.bom.v1.AutoMatchReply
	27, // 68: api.bom.v1.BomService.DownloadTemplate:output_type -> api.bom.v1.DownloadTemplateReply
	11, // 69: api.bom.v1.BomService.GetBOM:output_type -> api.bom.v1.GetBOMReply
	13, // 70: api.bom.v1.BomService.GetMatchResult:output_type -> api.bom.v1.GetMatchResultReply
	17, // 71: api.bom.v1.BomService.ListMatchSources:output_type -> api.bom.v1.ListMatchSourcesReply
	20, // 72: api.bom.v1.BomService.GetMatchSourceDetail:output_type -> api.bom.v1.GetMatchSourceDetailReply
	23, // 73: api.bom.v1.BomService.ListManufacturerCanonicals:output_type -> api.bom.v1.ListManufacturerCanonicalsReply
	25, // 74: api.bom.v1.BomService.CreateManufacturerAlias:output_type -> api.bom.v1.CreateManufacturerAliasReply
	29, // 75: api.bom.v1.BomService.CreateSession:output_type -> api.bom.v1.CreateSessionReply
	31, // 76: api.bom.v1.BomService.GetSession:output_type -> api.bom.v1.GetSessionReply
	34, // 77: api.bom.v1.BomService.ListSessions:output_type -> api.bom.v1.ListSessionsReply
	31, // 78: api.bom.v1.BomService.PatchSession:output_type -> api.bom.v1.GetSessionReply
	37, // 79: api.bom.v1.BomService.PutPlatforms:output_type -> api.bom.v1.PutPlatformsReply
	39, // 80: api.bom.v1.BomService.GetReadiness:output_type -> api.bom.v1.GetReadinessReply
	46, // 81: api.bom.v1.BomService.GetBOMLines:output_type -> api.bom.v1.GetBOMLinesReply
	45, // 82: api.bom.v1.BomService.GetSessionSearchTaskCoverage:output_type -> api.bom.v1.GetSessionSearchTaskCoverageReply
	48, // 83: api.bom.v1.BomService.CreateSessionLine:output_type -> api.bom.v1.CreateSessionLineReply
	50, // 84: api.bom.v1.BomService.PatchSessionLine:output_type -> api.bom.v1.PatchSessionLineReply
	52, // 85: api.bom.v1.BomService.DeleteSessionLine:output_type -> api.bom.v1.DeleteSessionLineReply
	55, // 86: api.bom.v1.BomService.RetrySearchTasks:output_type -> api.bom.v1.RetrySearchTasksReply
	57, // 87: api.bom.v1.BomService.SubmitBomSearchResult:output_type -> api.bom.v1.SubmitBomSearchResultReply
	60, // 88: api.bom.v1.BomService.ListLineGaps:output_type -> api.bom.v1.ListLineGapsReply
	62, // 89: api.bom.v1.BomService.ResolveLineGapManualQuote:output_type -> api.bom.v1.ResolveLineGapManualQuoteReply
	64, // 90: api.bom.v1.BomService.SelectLineGapSubstitute:output_type -> api.bom.v1.SelectLineGapSubstituteReply
	66, // 91: api.bom.v1.BomService.SaveMatchRun:output_type -> api.bom.v1.SaveMatchRunReply
	69, // 92: api.bom.v1.BomService.ListMatchRuns:output_type -> api.bom.v1.ListMatchRunsReply
	72, // 93: api.bom.v1.BomService.GetMatchRun:output_type -> api.bom.v1.GetMatchRunReply
	74, // 94: api.bom.v1.BomService.ExportSession:output_type -> api.bom.v1.ExportSessionReply
	79, // 95: api.bom.v1.HsResolveService.ResolveByModel:output_type -> api.bom.v1.HsResolveByModelReply
	81, // 96: api.bom.v1.HsResolveService.GetResolveTask:output_type -> api.bom.v1.HsResolveTaskReply
	83, // 97: api.bom.v1.HsResolveService.ConfirmResolve:output_type -> api.bom.v1.HsResolveConfirmReply
	86, // 98: api.bom.v1.HsResolveService.GetResolveHistory:output_type -> api.bom.v1.HsResolveHistoryReply
	77, // 99: api.bom.v1.HsResolveService.UploadHsManualDatasheet:output_type -> api.bom.v1.UploadHsManualDatasheetReply
	89, // 100: api.bom.v1.HsMetaService.ListHsMeta:output_type -> api.bom.v1.HsMetaListReply
	93, // 101: api.bom.v1.HsMetaService.CreateHsMeta:output_type -> api.bom.v1.HsMetaMutationReply
	93, // 102: api.bom.v1.HsMetaService.UpdateHsMeta:output_type -> api.bom.v1.HsMetaMutationReply
	93, // 103: api.bom.v1.HsMetaService.DeleteHsMeta:output_type -> api.bom.v1.HsMetaMutationReply
