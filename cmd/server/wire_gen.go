...
func wireApp(bootstrap *conf.Bootstrap, bootstrapProxy *conf.BootstrapProxy, logger log.Logger) (*kratos.App, func(), error) {
	...
	hsResolveService := service.NewDefaultHsResolveService(bootstrap, logger, hsModelMappingRepo, hsDatasheetAssetRepo, hsModelRecommendationRepo, hsItemQueryRepo, openAIChat)
