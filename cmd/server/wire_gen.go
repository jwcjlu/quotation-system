...
func wireApp(bootstrap *conf.Bootstrap, bootstrapProxy *conf.BootstrapProxy, logger log.Logger) (*kratos.App, func(), error) {
	...
	hsModelMappingRepo := data.NewHsModelMappingRepo(dataData)
	...
	hsResolveService := service.NewDefaultHsResolveService(bootstrap, logger, hsModelMappingRepo, hsDatasheetAssetRepo, hsModelRecommendationRepo, hsItemQueryRepo, hsModelTaskRepo, openAIChat, hsModelFeaturesRepo, cachedBomManufacturerAliasRepo)
