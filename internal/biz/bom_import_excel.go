...
var headerAliases = map[string][]string{
	...
	"mfr":         {"厂牌", "制造商", "品牌", "mfr", "manufacturer", "mfg", "厂商", "厂家"},
	"package":     {"封装", "package", "footprint", "封装类型", "外形尺寸"},
	"qty":         {"数量", "qty", "用量", "quantity", "需求数量", "qty(quantity)"},
	"params":      {"参数", "参数说明", "规格参数"},
	"description": {"描述", "规格", "描述/规格", "description", "desc", "物料描述", "功能说明"},
	"remark":      {"备注", "remark", "note", "notes", "comment", "说明", "特殊要求"},
	"unified_mpn": {"统一型号", "标准型号", "规范型号", "内部型号", "standard pn", "归一型号"},
	"refdes":      {"位号", "位号/位号列表", "refdes", "reference designator", "designator", "reference"},
	"substitute":  {"替代型号", "替代料号", "替代型号料号", "substitute", "alternate mpn", "alt pn", "alternative", "替代料", "第二来源"},
	"raw_text":    {"原始文本", "原文"},
}
