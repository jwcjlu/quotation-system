...
func newBomSearchTaskStatusServiceTest() (*BomService, *bomSessionRepoStub, *bomSearchTaskRepoStub) {
...
func (r *bomSessionRepoStub) CreateSession(context.Context, string, []string, *string, *string, *string, *string, *string) (string, time.Time, int, error) {
...
func (r *bomSessionRepoStub) PatchSession(context.Context, string, *string, *string, *string, *string, *string, *string) error {
	return nil
}

func (r *bomSessionRepoStub) PutPlatforms(context.Context, string, []string, int32) (int, error) {
	return 0, nil
}

func (r *bomSessionRepoStub) ListSessions(context.Context, int32, int32, string, string, string) ([]biz.BOMSessionListItem, int32, error) {
	return nil, 0, nil
}

func (r *bomSessionRepoStub) ReplaceSessionLines(context.Context, string, []biz.BomImportLine, *string) (int, error) {
	return 0, nil
}
...
func (r *bomSessionRepoStub) SetSessionStatus(context.Context, string, string) error {
	return nil
}

func (r *bomSessionRepoStub) CreateSessionLine(context.Context, string, string, string, string, *float64, *string, *string) (int64, int32, int, error) {
	return 0, 0, 0, nil
}

func (r *bomSessionRepoStub) DeleteSessionLine(context.Context, string, int64) error {
	return nil
}

func (r *bomSessionRepoStub) UpdateSessionLine(context.Context, string, int64, *string, *string, *string, *float64, *string, *string) (int, error) {
	return 0, nil
}
...
func (r *bomSearchTaskRepoStub) LoadSearchTaskByCaichipTaskID(context.Context, string) (*biz.BOMSearchTaskLookup, error) {
	return nil, nil
}

func (r *bomSearchTaskRepoStub) FinalizeSearchTask(context.Context, string, string, string, time.Time, string, string, *string, string, []byte, []byte) error {
	return nil
}
...
func (r *bomSearchTaskRepoStub) ListTasksForSession(context.Context, string) ([]biz.TaskReadinessSnapshot, error) {
	return nil, nil
}

func (r *bomSearchTaskRepoStub) ListActiveBySession(context.Context, string) ([]biz.TaskReadinessSnapshot, error) {
	return nil, nil
}

func (r *bomSearchTaskRepoStub) CancelBySessionPlatform(context.Context, string, string) (int64, error) {
	return 0, nil
}

func (r *bomSearchTaskRepoStub) MarkSkippedBySessionPlatform(context.Context, string, string) (int64, error) {
	return 0, nil
}

func (r *bomSearchTaskRepoStub) CancelAllTasksBySession(context.Context, string) error { return nil }

func (r *bomSearchTaskRepoStub) CancelTasksBySessionMpnNorm(context.Context, string, string) error {
	return nil
}
...
func (r *bomSearchTaskRepoStub) UpdateTaskStateBySessionKey(context.Context, string, string, string, time.Time, string) error {
	return nil
}

func (r *bomSearchTaskRepoStub) ListSearchTaskLookupsByCaichipTaskID(context.Context, string) ([]biz.BOMSearchTaskLookup, error) {
	return nil, nil
}

func (r *bomSearchTaskRepoStub) ListPendingLookupsByMergeKey(context.Context, string, string, time.Time) ([]biz.BOMSearchTaskLookup, error) {
	return nil, nil
}

func (r *bomSearchTaskRepoStub) LoadQuoteCacheByMergeKey(context.Context, string, string, time.Time) (*biz.QuoteCacheSnapshot, bool, error) {
	return nil, false, nil
}

func (r *bomSearchTaskRepoStub) LoadQuoteCachesForKeys(context.Context, time.Time, []biz.MpnPlatformPair) (map[string]*biz.QuoteCacheSnapshot, error) {
	return nil, nil
}

func (r *bomSearchTaskRepoStub) DistinctPendingMergeKeysForSession(context.Context, string) ([]biz.MergeKey, error) {
	return nil, nil
}
